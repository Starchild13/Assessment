...
// Assuming R.drawable.checkbox_checked and R.drawable.checkbox_unchecked are your drawables
            ...
            Row(
                modifier = Modifier.fillMaxWidth(), // Ensures the Row fills the horizontal space
                verticalAlignment = Alignment.CenterVertically, // Aligns children vertically in the center
                horizontalArrangement = Arrangement.SpaceBetween // Places the children at the start and end of the Row
            ) {
                Text(
                ...
                Text(
                    ...
                    fontSize = 12.sp, // Adjust the font size as needed
                    modifier = Modifier.align(Alignment.CenterVertically) // Optional, for vertical alignment if necessary
                )
            }
